        ...
        <div className='flex flex-col-reverse md:grid md:grid-cols-2 bgColor h-screen overflow-y-auto relative'>
            <div className='flex flex-col justify-center px-6 sm:px-12 py-6 relative'>
                ...
                <p className='text-lg mb-4 bodyColor'>
                    We've got your info and we're on it. Expect to hear from Travis soon.
                </p>
                ...
                <div className='mt-10 pt-6' style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
                    <p className='text-sm bodyColor'>
                        <strong style={{ color: '#ffffff' }}>Local Threads</strong> &middot; 7326 Morton View Lane, Powell, TN 37849
                    </p>
                    <p className='text-sm bodyColor'>candice@localthreadsohio.com</p>
                </div>
            </div>
